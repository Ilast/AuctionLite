...
L["|cff808080(per stack)|r"] = "|cff808080(par tas)|r"
...
L["|cffff0000Invalid stack size/count.|r"] = "|cffff0000Nbre/Tas invalide.|r"
...
L["|cffff0000Using %.1gx vendor price.|r"] = "|cffff0000Utilisation de %.1gx le prix marchand.|r"
...
L["Current: %s (%.2gx historical)"] = "Actuel : %s (%.2gx l'historique)"
L["Current: %s (%.2gx historical, %.2gx vendor)"] = "Actuel : %s (%.2gx l'historique, %.2gx le prix marchand)"
L["Current: %s (%.2gx vendor)"] = "Actuel : %s (%.2gx le prix marchand)"
...
L["Show Full Stack Price"] = "Afficher le prix du tas"
L["Show full stack prices in tooltips (shift toggles on the fly)."] = "Affiche les prix des tas dans les bulles d'aide (shift pour le faire à la volée)"
