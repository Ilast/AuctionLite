...
L["Cancel All Auctions"] = "Отменить все аукционы"
...
L["|cffff7030Stack %d will have %d |4item:items;.|r"] = "|cffff7030Партия %d содержит %d |4предмет:предметов;.|r"
...
L["Default Number of Stacks"] = "Количество партий по умолчанию."
L["Default Stack Size"] = "Размер партии по умолчанию"
L["%dh"] = "%d ч."
L["Disable"] = "Отключить"
...
L["Item"] = "Предмет"
L["Items"] = "Предметы"
L["Item Summary"] = "Предметы"
L["Last Used Tab"] = "Последняя открытая вкладка"
L["Listings"] = "Списки"
L["Market Price"] = "Рыночная цена"
L["Max Stacks"] = "Макс. партий"
L["Max Stacks + Excess"] = "Макс. партий + излишек"
...
L["Number of stacks suggested when an item is first placed in the \"Sell\" tab."] = "Количество партий, предлагаемое в случае, когда предмет впервые помещается в ячейку \"Продать\"."
L["One Item"] = "1 предмет"
L["One Stack"] = "Одна партия"
...
L["Search"] = "Поиск"
L["Searching:"] = "Поиск:"
L["Selected Stack Size"] = "Выбранный размер партии"
L["Sell Tab"] = "Продать"
...
L["Stack size suggested when an item is first placed in the \"Sell\" tab."] = "Размер партии, предлагаемый в случае, когда предмет впервые помещается в ячейку \"Продать\"."
...
L["VENDOR_WARNING"] = "Цена выкупа ниже цены продажи торговцу. Все равно создать такой аукцион?"
