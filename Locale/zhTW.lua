...
L["Advanced"] = "高級"
L["Always"] = "總是"
L["Amount to multiply by vendor price to get default sell price."] = "默認售價等於商人出售乘以你設置的倍數。"
L["Approve"] = "核准"
L["Auction"] = "拍賣"
...
-- L["Buyout cost for %d:"] = ""
L["Buyout Per Item"] = "一口價/件"
L["Buyout Price"] = "一口價"
L["Buyout Total"] = "一口價"
L["Buyout Undercut"] = "一口價削價"
-- L["Buy Tab"] = ""
L["Cancel"] = "取消"
...
L["|cffffd000Using historical data.|r"] = "|cffffd000使用歷史資料。|r" -- Needs review
...
L["Configure"] = "設置"
L["Configure AuctionLite"] = "設置AuctionLite"
...
L["Deals must be below the historical price by this much gold."] = "必須比歷史價格低這麼多金" -- Needs review
L["Deals must be below the historical price by this percentage."] = "必須比歷史價格低這麼多百分率" -- Needs review
-- L["Default"] = ""
-- L["%dh"] = ""
-- L["Disable"] = ""
L["Disenchant"] = "分解"
...
L["Open configuration dialog"] = "打開設置介面"
L["Percent to undercut market value for bid prices (0-100)."] = "將市場價削價後作為競標價的百分比（0-100）。"
L["Percent to undercut market value for buyout prices (0-100)."] = "將市場價削價後作為一口價的百分比（0-100）。"
-- L["per item"] = ""
-- L["per stack"] = ""
...
L["Show Deals"] = "顯示交易" -- Needs review
...
L["Vendor"] = "商人"
L["Vendor Multiplier"] = "商人倍數" -- Needs review
-- L["Vendor: %s"] = ""
