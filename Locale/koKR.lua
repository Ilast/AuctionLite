...
L["|cffff0000Using %.3gx vendor price.|r"] = "|cffff0000상점가의 %.3g배 가격으로 책정합니다.|r" -- Needs review
...
L["Current: %s (%.2fx historical)"] = "시세: %s (저장된 가격의 %.2f배)" -- Needs review
L["Current: %s (%.2fx historical, %.2fx vendor)"] = "시세: %s (저장된 가격의 %.2f배, 상점가의 %.2f배)" -- Needs review
L["Current: %s (%.2fx vendor)"] = "시세: %s (상점가의 %.2f배)" -- Needs review
