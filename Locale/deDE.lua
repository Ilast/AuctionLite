...
-- L["Cancelled %d |4listing:listings; of %s."] = ""
L["Cancelled %d listings of %s"] = "%d Auktionen von %s abgebrochen" -- Needs review
-- L["CANCEL_TOOLTIP"] = ""
-- L["Cancel Unbid"] = ""
...
L["Created %d |4auction:auctions; of %s x%d (%s total)."] = "\"%d |4Auktion:Auktionen; mit %3$dx %2$s erstellt (%s total).\"" -- Needs review
...
L["Historical: %s (%d |4listing:listings;/scan, %d |4item:items;/scan)"] = "Historisch: %s (%d |4Auktion:Auktionen;/Scan, %d |4Gegenstand:Gegenstände;/Scan)" -- Needs review
...
L["Listings"] = "Auktionen" -- Needs review
...
L["per item"] = "Gegenstand" -- Needs review
L["per stack"] = "Stapel"
